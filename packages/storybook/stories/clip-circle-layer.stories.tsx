...
export const ClipCircleLayerTest: Story = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const clipCircleLayer = new ClipCircleLayer(
        Circle.fromXYR(
          shapes.rect.cullRect.width / 2,
          shapes.rect.cullRect.height / 2,
          shapes.rect.cullRect.width / 2,
        ),
      )
      offsetLayer.appendChild(clipCircleLayer)
      const pictureLayer = new PictureLayer(Point.fromXY(0, 0))
      pictureLayer.picture = shapes.rect
      clipCircleLayer.appendChild(pictureLayer)
...
ClipCircleLayerTest.storyName = 'ClipCircleLayer'
