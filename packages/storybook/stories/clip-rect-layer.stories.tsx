...
export const ClipRectLayerTest: StoryObj<React.FC> = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const clipRectLayer = new ClipRectLayer(Rect.fromLTWH(CLIP_PADDING, CLIP_PADDING, shapes.rect.cullRect.width - CLIP_PADDING * 2, shapes.rect.cullRect.height - CLIP_PADDING * 2))
      offsetLayer.appendChild(clipRectLayer)
      const INNER_CLIP_PADDING = 20
      const innerClipRectLayer = new ClipRectLayer(Rect.fromLTWH(0, 0, shapes.rect.cullRect.width - INNER_CLIP_PADDING * 2, shapes.rect.cullRect.height - INNER_CLIP_PADDING * 2))
      clipRectLayer.appendChild(innerClipRectLayer)
      const pictureLayer = new PictureLayer(Point.fromXY(0, 0))
      pictureLayer.picture = shapes.rect
      innerClipRectLayer.appendChild(pictureLayer)
...
ClipRectLayerTest.storyName = 'ClipRectLayer'

export default {
  title: 'core/compositing',
  component: ClipRectLayerTest,
